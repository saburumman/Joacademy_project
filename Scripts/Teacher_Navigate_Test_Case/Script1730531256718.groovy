...
def findActualText = findTestObject('Object Repository/Login_Objects/Teachers_Page- joacademy.com/Teacher_Page_Title')

String actualText = WebUI.getText(findActualText)

// Check if the text exists within the specified <h1> element
boolean textExists = WebUI.verifyElementText(findTestObject('Object Repository/Login_Objects/Teachers_Page- joacademy.com/Teacher_Page_Title'), expectedText)
...
WebUI.setText(findTestObject('Object Repository/Login_Objects/Teachers_Page- joacademy.com/Search_Box_for_Teacher'), 'حسام باسل ع')

WebUI.verifyElementPresent(findTestObject('Object Repository/Login_Objects/Teachers_Page- joacademy.com/No_Search_Results'), 
    0)

WebUI.takeScreenshot('Screenshots/Teachers_No_Results.png')

WebUI.click(findTestObject('Login_Objects/Teachers_Page- joacademy.com/Reset_Filters'))
...
// Use JavaScript to center the element on the screen
JavascriptExecutor js5 = (JavascriptExecutor) DriverFactory.getWebDriver()
...
def dynamicImageObject = findTestObject('Object Repository/Login_Objects/Teachers_Page- joacademy.com/Saved_Teacher_Photo', 
    [('altValue') : teacherImageAlt])
...
//Unsave Teacher
WebUI.doubleClick(findTestObject('Object Repository/Login_Objects/Teachers_Page- joacademy.com/Selected_Fav_Icon'))

//Navigate to Courses, to refresh Teachers tab
WebUI.click(findTestObject('Object Repository/Login_Objects/Favorite_Page/Courses_Fav'))
WebUI.delay(5)
//Navigate back to Teachers tab
WebUI.click(findTestObject('Object Repository/Login_Objects/Favorite_Page/Teacher_In_Fav_Page'))
//Veify Element is not present
WebUI.verifyElementNotPresent(findTestObject('Login_Objects/Teachers_Page- joacademy.com/Selected_Fav_Icon'), 0)
