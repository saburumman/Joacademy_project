...
if(WebUI.verifyElementText(findTestObject('Object Repository/social media sites/Page_- joacademy.com/verify tittle Download the app'), 'حمل تطبيق الهاتف المحمول لجو اكاديمي على موبايلك')) {print("passed")
