...
// Find the element
TestObject officehourdates = findTestObject('Object Repository/FarahAnasweh/office hour/office hour first element/first element in dates of office hours')
...
WebUI.click(findTestObject('Object Repository/FarahAnasweh/office hour/office hour first element/first element office hour'))
...
TestObject toastMessage = findTestObject('Object Repository/FarahAnasweh/office hour/home page in tawjihi program/success Message when adding office hour')
...
if (WebUI.waitForElementPresent(toastMessage, 10, FailureHandling.OPTIONAL)) {
    ...
    if (actualMessage.contains(successMessage)) {
		...
		TestObject officehoursidebar =findTestObject('Object Repository/FarahAnasweh/office hour/my calender side bar/my calender button')
		// Use JavaScript to center the element on the screen
...
WebUI.click(officehourcalender)
       // WebUI.click(findTestObject('Object Repository/FarahAnasweh/office hour/my calender side bar/office hours in my calender first scenario'))
